...
|             [Anytxt Search](https://anytxt.net/)             |       文件内容搜索工具       |
...
|             [Geek](https://geekuninstaller.com/)             |         干净卸载软件         |
|                 [Git](https://git-scm.com/)                  |      分布式版本控制系统      |
|        [Google Chrome](https://www.google.cn/chrome/)        |          谷歌浏览器          |
|        [IDEA](https://www.jetbrains.com/zh-cn/idea/)         |       开发 Java 的 IDE       |
|         [ImageGlass](https://imageglass.org/support)         |          图片查看器          |
...
|                 [MQTTX](https://mqttx.app/)                  |       MQTT 连接客户端        |
| [Navicat Premium](https://www.navicat.com.cn/products/navicat-premium/) |        数据库管理工具        |
|                  [Nmap](https://nmap.org/)                   |      IP 与 端口扫描工具      |
|            [OBS Studio](https://obsproject.com/)             |         推流录屏软件         |
|                [Ollama](https://ollama.com/)                 |         LLM 运行工具         |
|       [PDF-Guru](https://github.com/kevin2li/PDF-Guru)       |      本地 PDF 编辑工具       |
...
|   [siyuan-unlock](https://github.com/appdev/siyuan-unlock)   | 免登录同步版 SiYuan 笔记软件 |
|           [spacedesk](https://www.spacedesk.net/)            |   用于把其他设备变成拓展屏   |
|           [Steam](https://store.steampowered.com/)           |     会员免费畅玩所有游戏     |
|       [sumatraPDF](https://www.sumatrapdfreader.org/)        |         PDF 阅读工具         |
...
|     [Visual Studio Code](https://code.visualstudio.com/)     |        超好用的编辑器        |
|               [VLC](https://www.videolan.org/)               |         视频播放软件         |
...
|           [阿里云盘](https://www.aliyundrive.com/)           |        阿里推出的网盘        |
...
|              [夸克网盘](https://www.quark.cn/)               |        资源蛮多的网盘        |
